...
var databricksScalars = []string{
	...
	"st_aswkb", "st_aswkt", "st_azimuth", "st_boundary", "st_buffer",
	"st_centroid", "st_closestpoint", "st_concavehull", "st_contains", "st_convexhull",
	"st_covers", "st_difference", "st_dimension", "st_disjoint", "st_distance",
	"st_distancesphere", "st_distancespheroid", "st_dump", "st_dwithin", "st_endpoint",
	"st_envelope", "st_envelope_agg", "st_equals", "st_exteriorring", "st_flipcoordinates",
	"st_geogfromewkt", "st_geogfromgeojson", "st_geogfromtext", "st_geogfromwkb", "st_geogfromwkt",
	"st_geohash", "st_geometryn", "st_geometrytype", "st_geomfromewkb", "st_geomfromewkt",
...
var databricksFunctionDocs = map[string]core.FunctionDoc{
	...
	"date_add": {
		...
		Signatures:  []string{"date_add(startDate, numDays)"},
	},
	"date_diff": {
	...
	"datediff": {
		...
		Signatures:  []string{"datediff(unit, start, end)unit { MICROSECOND |   MILLISECOND |   SECOND |   MINUTE |   HOUR |   DAY |   WEEK |   MONTH |   QUARTER |   YEAR }"},
	},
	"day": {
	...
	"decode": {
		...
		Signatures:  []string{"decode(expr, charSet)"},
	},
	"degrees": {
	...
	"st_azimuth": {
		Description: "This feature is in Public Preview.",
		Signatures:  []string{"st_azimuth ( geoExpr1, geoExpr2 )"},
	},
	"st_boundary": {
		Description: "This feature is in Public Preview.",
		Signatures:  []string{"st_boundary ( geoExpr )"},
	},
	"st_buffer": {
		Description: "This feature is in Public Preview.",
	...
	"st_closestpoint": {
		Description: "This feature is in Public Preview.",
		Signatures:  []string{"st_closestpoint ( geoExpr1, geoExpr2 )"},
	},
	"st_concavehull": {
		Description: "This feature is in Public Preview.",
	...
	"st_geogfromewkt": {
		Description: "This feature is in Public Preview.",
		Signatures:  []string{"st_geogfromewkt ( ewktExpr )"},
	},
	"st_geogfromgeojson": {
		Description: "This feature is in Public Preview.",
	...
	"st_geomfromewkt": {
		Description: "This feature is in Public Preview.",
		Signatures:  []string{"st_geomfromewkt ( ewktExpr )"},
	},
	"st_geomfromgeohash": {
		Description: "This feature is in Public Preview.",
