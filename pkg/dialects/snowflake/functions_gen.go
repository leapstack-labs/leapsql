...
var snowflakeScalars = []string{
	...
	"hex_encode", "hour", "iff", "ifnull", "initcap",
	"insert", "integration", "is_array", "is_binary", "is_boolean",
	"is_char", "is_date", "is_decimal", "is_double", "is_integer",
	"is_null_value", "is_object", "is_organization_user", "is_organization_user_group", "is_time",
	"jarowinkler_similarity", "json_extract_path_text", "last_day", "last_successful_scheduled_time", "least",
	"least_ignore_nulls", "left", "length", "ln", "log",
	"lower", "lpad", "ltrim", "map_cat", "map_contains_key",
	"map_delete", "map_insert", "map_keys", "map_pick", "map_size",
	"max", "md5", "md5_binary", "md5_number_lower64", "md5_number_upper64",
	"min", "mod", "model_monitor_drift_metric", "model_monitor_performance_metric", "model_monitor_stat_metric",
	"monthname", "months_between", "next_day", "null_count", "null_percent",
	"nullif", "nullifzero", "nvl", "nvl2", "object_construct",
	"object_construct_keep_null", "object_delete", "object_insert", "object_keys", "object_pick",
	"octet_length", "parse_document", "parse_ip", "parse_json", "parse_url",
	"parse_xml", "pi", "position", "pow", "previous_day",
	"prompt", "radians", "reduce", "regexp_count", "regexp_instr",
	"regexp_like", "regexp_replace", "regexp_substr", "regexp_substr_all", "regr_valx",
	"regr_valy", "repeat", "replace", "reverse", "right",
	"round", "row_count", "rpad", "rtrim", "rtrimmed_length",
	"sanitize_webhook_content", "scheduled_time", "search", "search_ip", "search_preview",
	"sentiment", "sha1", "sha1_binary", "sha2", "sha2_binary",
	"show_python_packages_dependencies", "sign", "sin", "sinh", "soundex",
	"soundex_p123", "space", "split", "split_part", "split_text_markdown_header",
	"split_text_recursive_character", "sqrt", "square", "st_area", "st_asewkb",
	"st_asewkt", "st_asgeojson", "st_aswkb", "st_aswkt", "st_azimuth",
	"st_buffer", "st_centroid", "st_collect", "st_contains", "st_coveredby",
	"st_covers", "st_difference", "st_dimension", "st_disjoint", "st_distance",
	"st_dwithin", "st_endpoint", "st_envelope", "st_geogfromgeohash", "st_geogpointfromgeohash",
	"st_geographyfromwkb", "st_geographyfromwkt", "st_geohash", "st_geometryfromwkb", "st_geometryfromwkt",
	"st_geomfromgeohash", "st_geompointfromgeohash", "st_hausdorffdistance", "st_interpolate", "st_intersection",
	"st_intersection_agg", "st_intersects", "st_isvalid", "st_length", "st_makegeompoint",
	"st_makeline", "st_makepoint", "st_makepolygon", "st_makepolygonoriented", "st_npoints",
	"st_perimeter", "st_pointn", "st_setsrid", "st_simplify", "st_srid",
	"st_startpoint", "st_symdifference", "st_transform", "st_union", "st_union_agg",
	"st_within", "st_x", "st_xmax", "st_xmin", "st_y",
	"st_ymax", "st_ymin", "startswith", "stddev", "strip_null_value",
	"strtok", "strtok_to_array", "substr", "summarize", "tan",
	"tanh", "text_html", "text_plain", "time_from_parts", "time_slice",
	"timeadd", "timediff", "timestamp_from_parts", "timestampadd", "timestampdiff",
	"to_array", "to_binary", "to_boolean", "to_char", "to_date",
	"to_decfloat", "to_decimal", "to_double", "to_file", "to_geography",
	"to_geometry", "to_json", "to_object", "to_time", "to_timestamp",
	"to_variant", "to_xml", "transform", "translate", "trim",
	"truncate", "try_base64_decode_binary", "try_base64_decode_string", "try_cast", "try_complete",
	"try_decrypt", "try_decrypt_raw", "try_hex_decode_binary", "try_hex_decode_string", "try_parse_json",
	"try_to_binary", "try_to_boolean", "try_to_date", "try_to_decfloat", "try_to_decimal",
	"try_to_double", "try_to_file", "try_to_geography", "try_to_geometry", "try_to_time",
	"try_to_timestamp", "typeof", "unicode", "unique_count", "upper",
	"vector_cosine_similarity", "vector_inner_product", "vector_l1_distance", "vector_l2_distance", "width_bucket",
	"xmlget", "zeroifnull",
}
...
var snowflakeTableFunctions = []string{
	...
	"iceberg_table_files", "iceberg_table_snapshot_refresh_history", "infer_schema", "listing_refresh_history", "login_history",
	"materialized_view_refresh_history", "network_rule_references", "notification_history", "online_feature_table_refresh_history", "pipe_usage_history",
	"policy_references", "query_acceleration_history", "query_history", "replication_group_dangling_references", "replication_group_refresh_history",
	"replication_group_refresh_progress", "replication_group_usage_history", "replication_usage_history", "rest_event_history", "result_scan",
	"search_optimization_history", "serverless_alert_history", "serverless_task_history", "split_to_table", "stage_directory_file_registration_history",
	"stage_storage_usage_history", "storage_lifecycle_policy_history", "strtok_split_to_table", "tag_references", "tag_references_all_columns",
	"tag_references_with_lineage", "task_dependents", "task_history", "to_query", "validate",
	"validate_pipe_load", "warehouse_load_history", "warehouse_metering_history",
}
...
var snowflakeFunctionDocs = map[string]core.FunctionDoc{
	...
	"ai_parse_document": {
		Description: "String & binary functions (AI Functions)",
		Signatures:  []string{"AI_PARSE_DOCUMENT( <file_object>, [ <options> ] )"},
	},
	"ai_redact": {
		Description: "String & binary functions (AI Functions)",
	...
	"haversine": {
		Description: "Calculates the great-circle distance in kilometers between two points on the Earth’s surface, using the Haversine formula. The two points are specified by their latitude and longitude in decimal ...",
	...
	"iceberg_table_files": {
		Description: "Returns information about the data files registered to an externally managed Apache Iceberg™ table at a specified point in time.",
		Signatures:  []string{"ICEBERG_TABLE_FILES(\n  TABLE_NAME => '<table_name>'\n  [, AT => '<timestamp_ltz>']\n)"},
	},
	"iceberg_table_snapshot_refresh_history": {
		Description: "Returns metadata and snapshot information about the most recent refresh history for a specified externally managed Apache Iceberg™ table.",
	...
	"is_organization_user": {
		Description: "Organization user and organization user group functions",
	...
	"st_buffer": {
		Description: "Returns a GEOMETRY object that represents a MultiPolygon containing the points within a specified distance of the input GEOMETRY object. The returned object effectively represents a “buffer” ar...",
	...
	"st_dimension": {
		Description: "Given a value of type GEOGRAPHY or GEOMETRY, return the “dimension” of the value. The dimension of a GEOGRAPHY or GEOMETRY value is:",
	...
	"try_to_boolean": {
		Description: "A special version of TO_BOOLEAN that performs the same operation (that is, converts an input expression to a Boolean value), but with error-handling support. If the conversion can’t be performed,...",
	...
	"try_to_decfloat": {
		Description: "A special version of TO_DECFLOAT that performs the same operation — that is, converts an input expression to a DECFLOAT — but with error-handling support. If the conversion can’t be performed...",
