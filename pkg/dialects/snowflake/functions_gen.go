...
var snowflakeFunctionDocs = map[string]dialect.FunctionDoc{
	...
	"ai_similarity": {
		Description: "Computes a similarity score based on the vector cosine similarity value of the inputs’ embedding vectors. Currently supports both text and image similarity computation.",
