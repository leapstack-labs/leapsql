...
var duckDBFunctionDocs = map[string]dialect.FunctionDoc{
	...
	"&": {
		...
		Signatures: []string{
			"&(left UTINYINT, right UTINYINT) -> UTINYINT",
		},
		ReturnType: "UTINYINT",
	},
	"&&": {
		...
		Signatures: []string{
			"&&(l1 ANY[], l2 ANY[]) -> BOOLEAN",
		},
		ReturnType: "BOOLEAN",
	},
	"*": {
		Signatures: []string{
			"*(col0 BIGINT, col1 INTERVAL) -> INTERVAL",
		},
		ReturnType: "INTERVAL",
	},
	"**": {
	...
	"<<": {
		...
		Signatures: []string{
			"<<(input SMALLINT, col1 SMALLINT) -> SMALLINT",
		},
		ReturnType: "SMALLINT",
	},
	"<=>": {
	...
	">>": {
		...
		Signatures: []string{
			">>(input UBIGINT, col1 UBIGINT) -> UBIGINT",
		},
		ReturnType: "UBIGINT",
	},
	"@": {
	...
	"^@": {
		...
		Signatures: []string{
			"^@(string VARCHAR, search_string VARCHAR) -> BOOLEAN",
		},
		ReturnType: "BOOLEAN",
	},
	"__internal_compress_integral_ubigint": {
		Signatures: []string{
			"__internal_compress_integral_ubigint(col0 UHUGEINT, col1 UHUGEINT) -> UBIGINT",
		},
		ReturnType: "UBIGINT",
	},
	"__internal_compress_integral_uinteger": {
		Signatures: []string{
			"__internal_compress_integral_uinteger(col0 HUGEINT, col1 HUGEINT) -> UINTEGER",
		},
		ReturnType: "UINTEGER",
	},
	"__internal_compress_integral_usmallint": {
		Signatures: []string{
			"__internal_compress_integral_usmallint(col0 UHUGEINT, col1 UHUGEINT) -> USMALLINT",
		},
		ReturnType: "USMALLINT",
	},
	"__internal_compress_integral_utinyint": {
		Signatures: []string{
			"__internal_compress_integral_utinyint(col0 BIGINT, col1 BIGINT) -> UTINYINT",
		},
		ReturnType: "UTINYINT",
	},
	"__internal_compress_string_hugeint": {
		Signatures: []string{
			"__internal_compress_string_hugeint(col0 VARCHAR) -> HUGEINT",
		},
		ReturnType: "HUGEINT",
	},
	"__internal_compress_string_ubigint": {
		Signatures: []string{
			"__internal_compress_string_ubigint(col0 VARCHAR) -> UBIGINT",
		},
		ReturnType: "UBIGINT",
	},
	"__internal_compress_string_uinteger": {
		Signatures: []string{
			"__internal_compress_string_uinteger(col0 VARCHAR) -> UINTEGER",
		},
		ReturnType: "UINTEGER",
	},
	"__internal_compress_string_usmallint": {
		Signatures: []string{
			"__internal_compress_string_usmallint(col0 VARCHAR) -> USMALLINT",
		},
		ReturnType: "USMALLINT",
	},
	"__internal_compress_string_utinyint": {
		Signatures: []string{
			"__internal_compress_string_utinyint(col0 VARCHAR) -> UTINYINT",
		},
		ReturnType: "UTINYINT",
	},
	"__internal_decompress_integral_bigint": {
		Signatures: []string{
			"__internal_decompress_integral_bigint(col0 UTINYINT, col1 BIGINT) -> BIGINT",
		},
		ReturnType: "BIGINT",
	},
	"__internal_decompress_integral_hugeint": {
		Signatures: []string{
			"__internal_decompress_integral_hugeint(col0 UINTEGER, col1 HUGEINT) -> HUGEINT",
		},
		ReturnType: "HUGEINT",
	},
	"__internal_decompress_integral_integer": {
		Signatures: []string{
			"__internal_decompress_integral_integer(col0 USMALLINT, col1 INTEGER) -> INTEGER",
		},
		ReturnType: "INTEGER",
	},
	"__internal_decompress_integral_smallint": {
		Signatures: []string{
			"__internal_decompress_integral_smallint(col0 UTINYINT, col1 SMALLINT) -> SMALLINT",
		},
		ReturnType: "SMALLINT",
	},
	"__internal_decompress_integral_ubigint": {
		Signatures: []string{
			"__internal_decompress_integral_ubigint(col0 UTINYINT, col1 UBIGINT) -> UBIGINT",
		},
		ReturnType: "UBIGINT",
	},
	"__internal_decompress_integral_uhugeint": {
		Signatures: []string{
			"__internal_decompress_integral_uhugeint(col0 UBIGINT, col1 UHUGEINT) -> UHUGEINT",
		},
		ReturnType: "UHUGEINT",
	},
	"__internal_decompress_integral_uinteger": {
		Signatures: []string{
			"__internal_decompress_integral_uinteger(col0 USMALLINT, col1 UINTEGER) -> UINTEGER",
		},
		ReturnType: "UINTEGER",
	},
	"__internal_decompress_integral_usmallint": {
		Signatures: []string{
			"__internal_decompress_integral_usmallint(col0 UTINYINT, col1 USMALLINT) -> USMALLINT",
		},
		ReturnType: "USMALLINT",
	},
	"__internal_decompress_string": {
		Signatures: []string{
			"__internal_decompress_string(col0 UTINYINT) -> VARCHAR",
		},
		ReturnType: "VARCHAR",
	},
	"abs": {
	...
	"|": {
		...
		Signatures: []string{
			"|(left UINTEGER, right UINTEGER) -> UINTEGER",
		},
		ReturnType: "UINTEGER",
	},
	"||": {
		Signatures: []string{
			"||(col0 ANY, col1 ANY) -> ANY",
		},
		ReturnType: "ANY",
	},
	"~": {
...
// duckDBKeywords contains all reserved keywords.
...
// duckDBDataTypes contains all supported data types.
var duckDBDataTypes = []string{
