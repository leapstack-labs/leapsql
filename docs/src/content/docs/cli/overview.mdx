...
- [run Command](/docs/cli/run) - Detailed run command reference
- [list Command](/docs/cli/list) - Model listing options
- [dag Command](/docs/cli/dag) - Dependency visualization
- [seed Command](/docs/cli/seed) - Seed loading options
- [docs Command](/docs/cli/docs) - Documentation generation
